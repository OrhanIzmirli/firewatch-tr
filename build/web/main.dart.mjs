...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1307: (x0,x1) => ({title: x0,text: x1}),
      _1308: x0 => ({text: x0}),
      _1317: () => globalThis.Notification.requestPermission(),
      _1325: (x0,x1) => x0.query(x1),
      ...
      _1328: (x0,x1,x2) => ({enableHighAccuracy: x0,timeout: x1,maximumAge: x2}),
      _1329: (x0,x1,x2,x3) => x0.getCurrentPosition(x1,x2,x3),
      _1334: (x0,x1) => x0.getItem(x1),
      _1336: (x0,x1,x2) => x0.setItem(x1,x2),
      _1352: x0 => globalThis.firebase_core.getApp(x0),
      _1356: x0 => globalThis.firebase_messaging.getMessaging(x0),
      _1358: (x0,x1) => globalThis.firebase_messaging.getToken(x0,x1),
      _1360: (x0,x1) => globalThis.firebase_messaging.onMessage(x0,x1),
      _1361: (x0,x1) => ({next: x0,error: x1}),
      _1366: x0 => x0.title,
      _1367: x0 => x0.body,
      _1368: x0 => x0.image,
      _1369: x0 => x0.messageId,
      _1370: x0 => x0.collapseKey,
      _1371: x0 => x0.fcmOptions,
      _1372: x0 => x0.notification,
      _1373: x0 => x0.data,
      _1374: x0 => x0.from,
      _1375: x0 => x0.analyticsLabel,
      _1376: x0 => x0.link,
      ...
      _1386: x0 => x0.apiKey,
      _1388: x0 => x0.authDomain,
      _1390: x0 => x0.databaseURL,
      _1392: x0 => x0.projectId,
      _1394: x0 => x0.storageBucket,
      _1396: x0 => x0.messagingSenderId,
      _1398: x0 => x0.measurementId,
      _1400: x0 => x0.appId,
      _1402: x0 => x0.name,
      _1403: x0 => x0.options,
      _1414: Date.now,
      ...
      _1442: s => JSON.stringify(s),
      _1443: s => printToConsole(s),
      _1444: (o, p, r) => o.replaceAll(p, () => r),
      _1445: (o, p, r) => o.replace(p, () => r),
      _1446: Function.prototype.call.bind(String.prototype.toLowerCase),
      _1447: s => s.toUpperCase(),
      _1448: s => s.trim(),
      _1449: s => s.trimLeft(),
      _1450: s => s.trimRight(),
      _1451: (string, times) => string.repeat(times),
      _1452: Function.prototype.call.bind(String.prototype.indexOf),
      _1453: (s, p, i) => s.lastIndexOf(p, i),
      _1454: (string, token) => string.split(token),
      _1455: Object.is,
      _1459: (o, c) => o instanceof c,
      _1460: o => Object.keys(o),
      _1490: x0 => new Array(x0),
      _1492: x0 => x0.length,
      _1494: (x0,x1) => x0[x1],
      _1495: (x0,x1,x2) => { x0[x1] = x2 },
      _1498: (x0,x1,x2) => new DataView(x0,x1,x2),
      _1500: x0 => new Int8Array(x0),
      _1501: (x0,x1,x2) => new Uint8Array(x0,x1,x2),
      _1503: x0 => new Uint8ClampedArray(x0),
      _1505: x0 => new Int16Array(x0),
      _1507: x0 => new Uint16Array(x0),
      _1509: x0 => new Int32Array(x0),
      _1511: x0 => new Uint32Array(x0),
      _1513: x0 => new Float32Array(x0),
      _1515: x0 => new Float64Array(x0),
      _1539: x0 => x0.random(),
      _1542: () => globalThis.Math,
      _1555: (ms, c) =>
      setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
      _1556: (handle) => clearTimeout(handle),
      _1557: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _1558: (handle) => clearInterval(handle),
      _1559: (c) =>
      ...
      _1614: x0 => x0.groups,
      _1615: x0 => x0.flags,
      _1616: x0 => x0.multiline,
      _1617: x0 => x0.ignoreCase,
      _1618: x0 => x0.unicode,
      _1619: x0 => x0.dotAll,
      _1620: (x0,x1) => { x0.lastIndex = x1 },
      _1621: (o, p) => p in o,
      _1622: (o, p) => o[p],
      _1625: () => new XMLHttpRequest(),
      _1628: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      _1629: (x0,x1) => x0.send(x1),
      _1630: x0 => x0.send(),
      ...
      _1647: (module,f) => finalizeWrapper(f, function(x0,x1,x2) { return module.exports._1647(f,arguments.length,x0,x1,x2) }),
      _1648: (x0,x1) => x0.forEach(x1),
      _1649: x0 => x0.getReader(),
      _1650: x0 => x0.cancel(),
      _1651: x0 => x0.read(),
      _1661: (x0,x1) => x0.key(x1),
      _1664: o => o instanceof Array,
      _1665: (a, i) => a.push(i),
      _1668: (a, l) => a.length = l,
      _1669: a => a.pop(),
      _1670: (a, i) => a.splice(i, 1),
      _1671: (a, s) => a.join(s),
      _1672: (a, s, e) => a.slice(s, e),
      _1674: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1675: a => a.length,
      _1677: (a, i) => a[i],
      _1678: (a, i, v) => a[i] = v,
      _1680: o => {
      ...
      _1681: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1683: o => o instanceof Uint8Array,
      _1684: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1685: o => o instanceof Int8Array,
      _1686: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1687: o => o instanceof Uint8ClampedArray,
      _1688: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1689: o => o instanceof Uint16Array,
      _1690: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1691: o => o instanceof Int16Array,
      _1692: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1693: o => o instanceof Uint32Array,
      _1694: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1695: o => o instanceof Int32Array,
      _1696: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1698: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1699: o => o instanceof Float32Array,
      _1700: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1701: o => o instanceof Float64Array,
      _1702: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1703: (t, s) => t.set(s),
      _1705: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1707: o => o.buffer,
      _1708: o => o.byteOffset,
      _1709: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1710: (b, o) => new DataView(b, o),
      _1711: (b, o, l) => new DataView(b, o, l),
      _1712: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1713: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1714: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1715: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1716: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1717: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1718: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1719: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1720: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1721: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1722: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1723: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1726: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1727: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1728: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1729: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1730: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1731: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1732: Function.prototype.call.bind(Number.prototype.toString),
      _1733: Function.prototype.call.bind(BigInt.prototype.toString),
      _1734: Function.prototype.call.bind(Number.prototype.toString),
      _1735: (d, digits) => d.toFixed(digits),
      _1829: x0 => x0.readyState,
      _1831: (x0,x1) => { x0.timeout = x1 },
      _1833: (x0,x1) => { x0.withCredentials = x1 },
      _1834: x0 => x0.upload,
      _1835: x0 => x0.responseURL,
      _1836: x0 => x0.status,
      _1837: x0 => x0.statusText,
      _1839: (x0,x1) => { x0.responseType = x1 },
      _1840: x0 => x0.response,
      _1852: x0 => x0.loaded,
      _1853: x0 => x0.total,
      _3622: () => globalThis.window,
      _3684: x0 => x0.navigator,
      _3948: x0 => x0.localStorage,
      _4052: x0 => x0.geolocation,
      _4055: x0 => x0.mediaDevices,
      _4057: x0 => x0.permissions,
      _4071: x0 => x0.userAgent,
      _4279: x0 => x0.length,
      _6224: x0 => x0.signal,
      _8057: x0 => x0.value,
      _8059: x0 => x0.done,
      _8756: x0 => x0.url,
      _8758: x0 => x0.status,
      _8760: x0 => x0.statusText,
      _8761: x0 => x0.headers,
      _8762: x0 => x0.body,
      _9149: x0 => x0.state,
      _10462: x0 => x0.coords,
      _10463: x0 => x0.timestamp,
      _10465: x0 => x0.accuracy,
      _10466: x0 => x0.latitude,
      _10467: x0 => x0.longitude,
      _10468: x0 => x0.altitude,
      _10469: x0 => x0.altitudeAccuracy,
      _10470: x0 => x0.heading,
      _10471: x0 => x0.speed,
      _10472: x0 => x0.code,
      _10473: x0 => x0.message,
      _12381: x0 => x0.name,
      _12382: x0 => x0.message,
      _13126: x0 => x0.name,
